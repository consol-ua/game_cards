...
class Level3 extends React.Component {
  _cards = [
    ...
    },
    {
      id: 21,
      name: "CSS",
      faceImg: "https://cdn.worldvectorlogo.com/logos/css3.svg",
    },
    {
      id: 22,
      name: "CSS",
    ...
    },
    {
      id: 23,
      name: "Like",
      faceImg: "https://cdn.worldvectorlogo.com/logos/facebook-like.svg",
    },
    {
      id: 24,
      name: "Like",
  ...
  renderCards() {
    ...
    if (this.props.level3.gameWin) {
      return (
        <div className={s.win__game}>
          Победа! Количество ходов: {this.props.level3.stepCount}
        </div>
      );
    }
    return cards.map((el) => {
